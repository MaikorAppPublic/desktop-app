...
fn code() -> [u8; 9000] {
    ...
    let ops = vec![
        MEM_CPY_ADDR_ADDR_BYTE, palette[0],palette[1], 0x17,0x70, 16*3,
...
fn altas() -> [u8; 4000] {
    ...
    let bytes = vec![
        17,17,17,17,17,0,0,17,17,0,0,17,17,0,0,17,17,0,0,17,17,0,0,17,17,0,0,17,17,0,0,17,17,17,17,17
    ];
